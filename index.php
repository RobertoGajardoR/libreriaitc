    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="login nav navbar-nav navbar-right">
            <li><a data-toggle="modal" data-target="#myModal1"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>
...
<div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <form id="form1" action="controlador/validar.php" method="post">
          <div class="modal-body">
            <fieldset>
              <div class="form-group">
              <label for="usuario">Ingrese usuario</label>
              <br>
              <input type="text" required maxlength="25" name="user" class="form-control"  >
              </div>   
              <div class="form-group">
              <label for="pass">Ingrese Contraseña</label>
              <br>
              <input type="password" required maxlength="25" name="pass" class="form-control" >
              </div>  
            ...
            <div class="modal-footer">
              ...
              <input type="reset" class="btn btn-danger"/><input class="btn btn-primary" type="submit" value="Ingresar">
